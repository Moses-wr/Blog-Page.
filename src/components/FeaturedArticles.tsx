...
// article4 is imported but not used in the articles array
...
interface Article {
  ...
  title: string;
  excerpt: string;
  image: any; // Using 'any' to avoid TypeScript errors with image imports
  href: string;
}
...
const FeaturedArticles = () => {
  return (
    <section aria-labelledby="featured-heading" className="container mx-auto py-14">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3"> {/* Changed from 4 to 3 since you only have 3 articles */}
        {articles.map((a) => (
