      ...
      <div className="grid gap-6 md:grid-cols-3">
        <Card className="border-dashed">
          <CardContent className="p-6">
            ...
            <div className="mt-4"><Button variant="outline" onClick={() => window.open('https://example.com/newsletter', '_blank')}>Learn More</Button></div>
          </CardContent>
        </Card>
        <Card className="border-dashed">
          <CardContent className="p-6">
            ...
            <div className="mt-4"><Button variant="outline" onClick={() => window.open('https://example.com/savings', '_blank')}>View Offer</Button></div>
          </CardContent>
        </Card>
        <Card className="border-dashed">
          <CardContent className="p-6">
            ...
            <div className="mt-4"><Button variant="brand" onClick={() => window.open('https://example.com/course', '_blank')}>Enroll Now</Button></div>
          </CardContent>
        </Card>
      </div>
    </section>
